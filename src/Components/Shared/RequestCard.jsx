...
const RequestCard = ({ request, requestType }) => {
    ...
    return (
        <div className="border space-y-1 rounded-md border-gray-400 bg-gradient-to-b from-white to-gray-300 shadow-lg p-2">
            <div className="flex justify-between text-gray-600">
                <div className="flex items-center gap-2">
                    <img src={donarImage ? donarImage : img} className="w-[40px] h-[40px] p-[1px] bg-red-400 rounded-full" alt="" />
                    <div>
                        <h4 className="text-xl font-bold">{donarName}</h4>
