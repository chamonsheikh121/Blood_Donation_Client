            ...
            <div className="bg-black text-white md:py-80 py-40">
                <div className="max-w-4xl space-y-6 md:px-10 px-5 lg:px-0 mx-auto text-center">
                    ...
                    <div className="flex flex-col w-full justify-start md:justify-center md:flex-row  md:w-full pl-5 md:pl-0 gap-5 ">
                        <button className=" rounded-md bg-red-700 text-white font-bold uppercase py-4 border-2 px-20 hover:bg-white hover:text-red-700 border-red-700">Join&nbsp;as  a&nbsp;donar</button>
